...
- `Улучшение` Записаны тесты в нативных процессах приложений arm64 на API 28, 31, 33 и 35: каждое устройство проходит 10 из 12 проверок в двух раундах; завершение при тайм-ауте и превышении вывода не работает при игнорировании SIGTERM, поэтому принудительное завершение остаётся блокирующим условием выпуска
