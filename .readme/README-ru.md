...
- `Улучшение` Добавлены пять проверок FD/SIGSYS: четыре нативных arm64-устройства (API 28/31/33/35) и нативный x86_64 AVD с API 33 дважды получили по 17/18. Изоляция дескрипторов дочерних процессов и проверки сигналов пройдены, но все 10 запусков выявили отсутствие резервного пути CLOEXEC при старте; блокирующая проблема сохранена без изменения официальных байтов и минимума Android 13
