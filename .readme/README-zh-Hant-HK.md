...
- `優化` 新增 5 項 FD/SIGSYS 專項探針: API 28/31/33/35 四台原生 arm64 實體裝置及 API 33 原生 x86_64 AVD 各兩輪 17/18. 子程序 FD 隔離與訊號驗證通過, 但全部 10 輪均揭示啟動階段缺少 CLOEXEC 後備路徑; 保留阻斷記錄, 不改動正式執行階段位元組及 Android 13 最低要求
