...
- `تحسين` إضافة خمسة اختبارات FD/SIGSYS: تسجل أربعة أجهزة arm64 أصلية (API 28/31/33/35) ومحاكي AVD أصلي x86_64 بمستوى API 33 نتيجة 17/18 في جولتين لكل منها. تنجح اختبارات عزل الواصفات والإشارات, لكن الجولات العشر تكشف غياب مسار CLOEXEC البديل عند بدء التشغيل; الاحتفاظ بهذا العائق دون تغيير بايتات المحرك الرسمي أو الحد الأدنى Android 13
