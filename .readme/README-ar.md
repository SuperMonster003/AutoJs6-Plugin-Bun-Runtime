...
- `تحسين` إغلاق جزء Cargo من سلسلة توريد البناء التجريبي لنظام Android 9+: قفل جميع أرشيفات crates.io البالغ عددها 181 وماديتها (26,354,160 بايت), وإنشاء directory source موثّق بالمجاميع الاختبارية, وإثبات أن Cargo المثبّت يقرأ مساحة عمل Bun كاملة باستخدام `--locked --offline` و`CARGO_HOME` فارغ; ولا يزال إغلاق حزم المضيف مفتوحًا
