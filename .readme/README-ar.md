...
- `إصلاح` إصلاح التسليم المبكر للإشارات المعلقة المحجوبة أثناء انتظار epoll التجريبي على Android: الحفاظ على قناع المستدعي وتطبيق الاستبعاد الحالي لاستدعاء epoll_pwait2 الاختياري. تجمع اختبارات GCC/Clang دالة الانتظار الأصلية والمصححة كاملة. تسجل البنى الأصلية الجديدة واختبارات الأجهزة غير المعدلة منفصلة مع الاحتفاظ بسجلات فشل التصحيحات الأحد عشر وحدود الدعم الرسمي
