...
- `تحسين` قفل مدخلات المصدر المطابق للـ runtime المعدّل من دون ادعاء اعتماد الإصدار: تثبيت مصدر Bun الأساسي بالحجم وSHA-256, والتحقق من WebKit/JSC عند tag وcommit وtree محددة وقائمة من 463,115 ملفًا, وإرفاق خمسة نصوص تراخيص مطابقة, ومراجعة 19 أرشيف native و206 من Cargo و125 من npm; ولا يزال النشر الفعلي للمصدر والمراجعة القانونية الخاصة بالإصدار مطلوبين
