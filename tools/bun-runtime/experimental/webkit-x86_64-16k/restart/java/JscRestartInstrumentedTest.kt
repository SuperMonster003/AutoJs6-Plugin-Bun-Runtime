...
class JscRestartInstrumentedTest {
    private val instrumentation = InstrumentationRegistry.getInstrumentation()
    private val context = instrumentation.targetContext

    @Test
    fun fixedProfilerRestartControls() {
        ...
        try {
            ...
            for (mode in listOf("target", "target-absent")) {
                ...
                try {
                            ...
                            synchronized(output) {
                                ...
                                when (event.getString(BunRuntimeContract.KEY_EVENT_TYPE)) {
                                    ...
                                    BunRuntimeContract.EVENT_STDOUT -> {
                                        ...
                                        if (output.length + text.length > 65536) callbackError.set("Restart output exceeded bound")
                    ...
                    val environment = Bundle().apply { putString("AUTOJS6_JSC_RESTART_MODE", mode) }
                    ...
                    instrumentation.sendStatus(0, Bundle().apply { putString("stream", "JSC_RESTART=" + archived.toString() + "\n") })
