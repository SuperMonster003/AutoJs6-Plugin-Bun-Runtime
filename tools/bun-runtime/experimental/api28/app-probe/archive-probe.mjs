...
export function archiveProbe(output, directories) {
  ...
  const archive = { schemaVersion: 1, kind: "archived-test-only-application-process-probes",
    ...
    scope: "Two process-restarted rounds of the fixed 25-probe test-only application suite per native environment. Not the full syscall/API/FD, plugin Binder or Release matrix.",
