// Fixed, shell-free asynchronous counterpart to the historical synchronous
// blocked-SIGSYS fixture. Never change that fixture or restore the mask early.
import { dlopen, ptr, read } from "bun:ffi";
import { openSync, closeSync, fstatSync, statSync, writeFileSync, existsSync } from "node:fs";
const mode = ASYNC_SIGNAL_MODE, trapped = mode === "trap";
...
const line = "ASYNC_SIGNAL_RESULT=" + JSON.stringify(proof);
