...
const EXPECTED_DOWNSTREAM_COMMIT = "7b9ac266888abda7ee6ec0b8ac11a74236420030";
...
export function verifyDistributionSourceManifest(lock) {
  ...
  requireEqual(lock.bunSource?.downstreamPatchCount, 9, "Bun downstream patch count");
