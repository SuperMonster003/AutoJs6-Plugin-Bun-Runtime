...
const EXPECTED_DOWNSTREAM_COMMIT = "a9c76a599bacb75c72d3c00fc6f99c5cc9483b47";
...
export function verifyDistributionSourceManifest(lock) {
  ...
  requireEqual(lock.bunSource?.downstreamPatchCount, 10, "Bun downstream patch count");
