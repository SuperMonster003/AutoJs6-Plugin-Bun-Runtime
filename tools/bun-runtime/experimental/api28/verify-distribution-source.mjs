...
const EXPECTED_DOWNSTREAM_COMMIT = "e8b1296169a8e6f20c81e926dba6448afb25cd11";
...
export function verifyDistributionSourceManifest(lock) {
  ...
  requireEqual(lock.bunSource?.downstreamPatchCount, 13, "Bun downstream patch count");
