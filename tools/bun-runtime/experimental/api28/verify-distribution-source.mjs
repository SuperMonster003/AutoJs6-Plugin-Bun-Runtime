...
const EXPECTED_DOWNSTREAM_COMMIT = "778ce669a38888457c36cab0f2231c3f25592b7d";
...
export function verifyDistributionSourceManifest(lock) {
  ...
  requireEqual(lock.bunSource?.downstreamPatchCount, 6, "Bun downstream patch count");
