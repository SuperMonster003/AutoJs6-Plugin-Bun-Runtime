...
function buildReleaseNotes(manifest) {
  ...
  return [
    ...
    ...(manifest.identity.profile === "official" ? [
      ...
      "All APKs pass 16 KB ZIP alignment and every ELF payload meets at least 16 KB PT_LOAD alignment. The signed arm64-v8a APK of this Release passed the black-box acceptance on a Samsung SM-A566B (Android 16, 16 KB pages) as a fresh install. The official native x86_64 runtime is still rejected on pages larger than 4 KiB.",
      "",
    ] : []),
