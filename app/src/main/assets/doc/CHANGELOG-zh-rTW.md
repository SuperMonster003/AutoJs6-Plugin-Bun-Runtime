...
* `優化` 不改實驗執行階段, 新增第 24 項 openat2 目錄約束探針: 五個原生 4 KiB 環境各兩輪 23/24. 原 230 項觀測通過, 新增 10 次失敗記錄相對/絕對/魔術連結讀取設定根外合成測試哨兵共 60 次. 不放寬斷言, 如實封存失敗門檻; 無當機, 停滯或測試 UID 程序殘留, 本輪 AVD 已關閉. 原生修正仍未實施
