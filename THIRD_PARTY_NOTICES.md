...
| Deterministic downstream head | `7b9ac266888abda7ee6ec0b8ac11a74236420030` |
| Downstream tree | `05f05ce5787a20f2af4d642fb0ada38f68674187` |
| Patch series | Five byte-equivalent backports at the compatibility prefix, one project-owned dependency pin, one MIT startup CLOEXEC fix, one MIT allocation-free spawn FD fix and one MIT read-only directory-confinement fallback; all nine are stored and hashed in [`patches/series.lock.json`](tools/bun-runtime/experimental/api28/patches/series.lock.json) |
| ARM64 reproducible output | 87,923,312 bytes; SHA-256 `186968ad26f1753675b3782cfa87c954530d47cd593e26b701e6d2ce02b4e333` |
| x86_64 reproducible output | 90,449,712 bytes; SHA-256 `f27375423557dcb61c7d5e66b71de0beb8431f20f6393e78aba34ee23dfda8d3` |
...
The exact Bun base source is locked as the 64,069,192-byte commit archive with SHA-256 `d44cad3fc8a3ab2e59308af42b022d2401b3425b98ffde535bfc02387dac4771`. Applying the checked-in nine-patch series produces the recorded downstream commit and tree. The first five patches preserve the MIT license of their pinned upstream commits; the sixth changes only the Brotli dependency reference from its movable tag to the same MIT-licensed source revision by immutable commit. The seventh adds project-owned MIT-licensed startup CLOEXEC handling, and the eighth provides a separate MIT-licensed Linux spawn FD fallback without allocating in the vfork child. The ninth adds a project-owned MIT read-only directory-confinement resolver and C/Rust wiring, without a new third-party dependency. Upstream byte-equivalence is checked at the complete five-patch prefix, not claimed for the final startup, spawn or scoped-open code. The previous [six-patch](docs/compatibility/2026-09-03-m2-runtime-evidence.json), [seven-patch](docs/compatibility/2026-09-10-m2-startup-runtime-evidence.json) and [eight-patch](docs/compatibility/2026-09-10-m2-spawn-runtime-evidence.json) build records remain unchanged.
